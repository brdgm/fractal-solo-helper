<template>
  ...
  <ModalDialog id="creditsModal" :title="t('footer.credits')">
    <template #body>
      <h4><a href="https://boardgamegeek.com/boardgame/299106/fractal" target="_blank" rel="noopener">{{t('gameTitle')}}</a></h4>
      <dl>
        <dt>Game design</dt>
        <dd>Yann Hilaire, Romain Lesiuk, Bernardo Rippe</dd>
        <dt>Graphics design</dt>
        <dd>Tom Lopez</dd>
        <dt>Publisher</dt>
        <dd><a href="https://boredgameink.com/" target="_blank" rel="noopener">Bored Game Ink</a></dd>
      </dl>
      ...
      <dl>
        ...
        <dt>Version</dt>
        <dd>{{buildNumber}} (<a href="https://github.com/brdgm/fractal-solo-helper/releases" target="_blank" rel="noopener">Change Log</a>)</dd>
        <dt>Source Code (Apache-2.0 License)</dt>
        <dd><a href="https://github.com/brdgm/fractal-solo-helper" target="_blank" rel="noopener">https://github.com/brdgm/fractal-solo-helper</a></dd>
      </dl>
